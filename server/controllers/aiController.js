...
export const enhanceJobDescription = async (req, res) => {
    try {
        ...
        const response = await ai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system", content: "Act as an expert career coach and ATS specialist to enhance the user content to a highly optimized, 1-2 sentence professional job description, ensuring the use of industry-standard keywords and a measurable impact-driven tone to maximize recruiter search visibility."
                },
                {
                    role: "user", content: userContent
                }
