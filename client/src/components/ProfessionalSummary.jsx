...
const ProfessionalSummary = ({ data, onChange, setResumeData }) => {
  ...
  const generateSummary = async () => {
    try {
      ...
      const prompt = `enhance my professional sumamry "${data}"`;
    ...
    <div className="space-y-4">
      ...
      <div className="mt-6">
        ...
        outline-none transition-colors resize-none"
          placeholder="Write a standard professional summary that highlights your key strengths and career objectives..."
        />
        <p className="text-xs text-gray-500 max-w-4/5 mx-auto text-center">
          Tip: Keep it concise and focus on your achievements and skills.
        </p>
      </div>
    </div>
  );
