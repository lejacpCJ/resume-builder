    ...
    <div className="max-w-4xl mx-auto bg-white text-gray-800">
      ...
      >
        <div className="flex justify-between items-start">
          <div>
            {/* Image for Modern - conditionally rendered if exists, maybe on the right or top? 
                            Let's put it on the top left or create a flex layout. 
                            Actually, modern templates often have the image in the header.
                            Let's keep the existing structure but add the image.
                        */}
