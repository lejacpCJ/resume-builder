...
import TemplateSector from "../components/TemplateSector";
...
const ResumeBuilder = () => {
  ...
  const handleShare = () => {
    ...
    if (navigator.share) {
      ...
      alert("Share not supported on thsi browser :(");
    }
  };
            ...
            <div className="relative w-full">
              ...
              <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                ...
                <button
                  ...
                  className="flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-green-100 to-green-200 
